...
/**
 * Why not just put a JRE condition directly on the test classes?
 ...
 * This in turn leads to UnsupportedClassVersionErrors before JUnit can evaluate the condition when running on older java versions (e.g. 11).
 * <p>
